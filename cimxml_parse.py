...
from .cim_obj import CIMInstance, CIMInstanceName, CIMQualifier, CIMProperty, tocimobj
from .tupleparse import parse_any, parse_classname, parse_classpath, parse_localclasspath
...
def parse_qualifier(parser, event, node):
    ...
    result = CIMQualifier(name, tocimobj(_type, value))
